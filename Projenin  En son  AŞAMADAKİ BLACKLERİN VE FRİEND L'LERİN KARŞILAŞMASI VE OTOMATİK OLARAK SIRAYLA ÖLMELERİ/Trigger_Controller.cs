...
public class Trigger_Controller : MonoBehaviour
{
    ...
    #region SON AÞAMA GELDÝÐÝMÝZ BU NOKTADA  þunlarý yapýcaksýn : 

    /* 
    
  1 ) Friend ve Black 'ler karþýlaþýp Punching Animasyonlarý oynadýktan SONRA [ 1.5 ] saniyede bir  teker teker ölsünler.

  2 ) Eðer Friend ve Black ' lerin sayýsý eþitse GALÝP OLAN  taraf Black olsun.

  3 ) Black ve Friend ' lerin sayýsýný nasýl YAKALICAM ? 
    
          --- Black ' lerin sayýsý zaten oyunda belli.

          --- Friend ' lerin sayýsý Trigger olduklarýnda yakalayabilir miyim bunu bir [ DENE. ]

          
  4 ) ZAMAN kýsmýný nasýl yapýcaz düþün ve ARAÞTIR ......
