...
public class RigidbodyCharacter : MonoBehaviour
{
    ...
    void Update()
    {
      ...
      -- Rigidbody.position, fizik motorunu kullanarak bir Rigidbody'nin KONUMUNU almanýzý ve ayarlamanýzý saðlar. 
       ...
       ( solver Iterations : Çözücü yinelemeleri )
        ...
        /*
           solverVelocityIterations : Çözücü Hýz Yinelemeleri
        ...
        iþte biz bu default 1 deðerini artýrarak Rigidbody 'nin Çarpýþmalarda hýz kararlýlýðýný artýrabiliyoruz.
